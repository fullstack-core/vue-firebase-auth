    ...
    <div class="login">
        <section class="forms">
            <form action="" class="register" @submit.prevent="register">
                <h2>Register</h2>
                <input type="email" name="" id="" placeholder="Email address..." v-model="register_form.email">
                <input type="password" name="" id="" placeholder="Password..." v-model="register_form.password">
